  ...
  const Contact = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const serviceID = 'service_vybdsh9'; // Votre Service ID EmailJS
        const templateID = 'template_o4zyed4'; // Votre Template ID EmailJS
        const publicKey = 'wy1lu2OLxxGd9fFY-'; // Votre Public Key EmailJS
